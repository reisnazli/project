...
for i_Sig = 1:size(x,2)
    ...
    if strcmp(toolbox,'matlab')
        D              = mswpd('col',Signals,'db1',J);   % WPT tree, the actual WP decomposition module using matlab toolbox
    else
        D              = mswpd_wmtsa(Signals,'db1',J);     % WPT tree, the actual WP decomposition module using wmtsa toolbox
