...
x1 <- read.csv("B_Acc_Body_CASE_1_20110908_B.txt")
x2 <- read.csv("B_Acc_Body_CASE_1_20110914_B.txt")
x3 <- read.csv("B_Acc_Body_CASE_1_20111213_B.txt")
x4 <- read.csv("B_Acc_Body_CASE_1_20111228_B.txt")
x5 <- read.csv("B_Acc_Body_CASE_1_20120105_B.txt")
x6 <- read.csv("B_Acc_Body_CASE_1_20120118_B.txt")
x7 <- read.csv("B_Acc_Body_CASE_1_20120131_B.txt")
x8 <- read.csv("B_Acc_Body_CASE_1_20120306_B.txt")
x9 <- read.csv("B_Acc_Body_CASE_1_20120518_B.txt")
x10 <- read.csv("B_Acc_Body_CASE_1_20120621_B.txt")
x11 <- read.csv("B_Acc_Body_CASE_1_20120731_B.txt")
x12 <- read.csv("B_Acc_Body_CASE_1_20120924_B.txt")
x13 <- read.csv("B_Acc_Body_CASE_1_20120926_B.txt")
x14 <- read.csv("B_Acc_Body_CASE_1_20130118_B.txt")
x15 <- read.csv("B_Acc_Body_CASE_1_20130311_B.txt")
x16 <- read.csv("B_Acc_Body_CASE_1_20130612_B.txt")

########################
##### Plot #####
########################

#x1_plot <- as.numeric(unlist(read.csv("B_Acc_Body_CASE_1_20110908_B.txt")))
